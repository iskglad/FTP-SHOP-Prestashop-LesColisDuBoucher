...
{if isset($p) AND $p}
	...
	{elseif isset($smarty.get.controller) && $smarty.get.controller == "guestbook"}
		{assign var='requestPage' value=$link->getPaginationLink('guestbook', $guestbook, false, false, true, false)}
		{assign var='requestNb' value=$link->getPaginationLink('guestbook', $guestbook, true, false, false, true)}
	{else}

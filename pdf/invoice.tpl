...
<table style="width: 100%">
	<tr>
		<td style="width: 15%; padding-right: 7px; text-align: right; vertical-align: top; font-size: 7pt;">
			...
			<br />
            <b>{l s='Date de livraison:' pdf='true'}</b><br />
            {dateFormat date=$order->date_delivery full=0}<br />
            {if $order->hour_delivery}
                {$order->hour_delivery}<br/>
            {/if}
		...
		<td style="width: 85%; text-align: right">
			...
			<table style="width: 100%">
                ...
                <!--Shipping-->
				{if $order_invoice->total_shipping_tax_incl > 0 && !$order->free_shipping_discount}
				    <tr style="line-height:5px;">

...
define('PREFIX_CART_RULE_FREE_SHIPPING', "FREE_SHIPPING_ID_CART_");
define('PREFIX_CART_REFUND_SHIPPING', "REFUND_SHIPPING_ID_CART_");

define('RULE_NAME_FREE_SHIPPING', "Frais de livraison offerts");
define('RULE_NAME_REFUND_SHIPPING', "Frais de livraison remboursés");
define('ID_ATTRIBUTE_CARD_PRO', 32);
define('ID_ATTRIBUTE_CARD_NORMAL', 31);

define('ID_ATTRIBUTE_GROUP_LABEL', 6);

define('ID_ZONE_PARIS', 1);
define('ID_ZONE_PETITE_BANLIEUE', 9);
define('ID_ZONE_GRANDE_BANLIEUE', 10);
define('ID_ZONE_PROVINCE', 11);
define('ID_ZONE_JET', 9);
define('ID_ZONE_ECOLOTRANS', 10);
define('ID_ZONE_UPS', 11);
define('ID_RELAY_CARRIER', 88);

define('ID_CATEGORY_MAIN', 3);
define('ID_CATEGORY_SURPRISE', 4);
define('ID_CATEGORY_PROMOTIONS', 5);
define('ID_CATEGORY_GIFT', 7);
define('ID_CATEGORY_BOEUF', 8);
define('ID_CATEGORY_YMLB', 96);
define('ID_CATEGORY_MATUREES', 4934);
define('ID_CATEGORY_SPECIAL_FETE', 4935);
define('ID_CATEGORY_REPAS_DE_FETE', 4936);
...
define('ID_ORDER_STATE_CANCELED', 6);
define('ID_ORDER_STATE_REFUND', 7);
define('ID_ORDER_STATE_PAYMENT_ERROR', 8);
define('ID_ORDER_STATE_WAITING_BANKWIRE_PAYMENT', 10);
define('ID_ORDER_STATE_WAITING_PAYPAL_PAYMENT', 11);
...
define('CARRIER_TYPE_RELAY', 2);

define('DELIVERY_FREE_SHIPPING_UPS_EXPRESS', 250);

define('NB_STOCK_INFINITE', 100000); //infinite products stock = 100000, used in override/class/stock/stockavailable line 32

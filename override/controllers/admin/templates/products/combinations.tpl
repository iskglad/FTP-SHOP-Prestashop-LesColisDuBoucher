		...
		<table>
            ...
            <tr>
                <td style="width:150px;vertical-align:top;text-align:right;padding-right:10px;font-weight:bold;" class="col-left">
                    ...
                    <label>{l s='Begin date:'}</label>
                </td>
            <td style="padding-bottom:5px;">
                <input class="datepicker" id="begin_date_attribute" name="begin_date_attribute" value="{$available_date}" style="text-align: center;" type="text" />
                <p>{l s='The date when this product start to be avalaible'}</p>
                <script type="text/javascript">
                    $(document).ready(function(){

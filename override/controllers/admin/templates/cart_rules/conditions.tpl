...
<!--Use Date valid interval-->
<label>Date limite d'utilisation</label>
<div class="margin-form">
...
<div class="margin-form">
	<strong>{l s='from'}</strong>
	<input type="text" class="datepicker" name="date_shipping_from"
		value="{if $currentTab->getFieldValue($currentObject, 'date_shipping_from')}{$currentTab->getFieldValue($currentObject, 'date_shipping_from')|escape}{else}{$defaultDateShippingFrom}{/if}" />
	<strong>{l s='to'}</strong>
